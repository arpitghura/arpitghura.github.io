    ...
    <>
      <div className="flex flex-col items-center justify-center bg-gray_900 h-[85dvh]" id='hero'>
        ...
        <div className="flex sm:flex-col flex-row sm:gap-10 gap-[78px] items-center justify-center mt-[38px]">
          <a
            className="cursor-pointer  leading-[normal] min-w-[187px] py-4 text-center text-gray_900 rounded-[20px] text-lg bg-cyan_400 border border-cyan-400 font-bold"
          ...
          <a
            className="cursor-pointer leading-[normal] min-w-[187px] py-4 text-center bg-blue_gray_900 text-cyan_400 border border-cyan-400 text-lg rounded-[20px] font-bold"
            href='#contact'
          >
            Contact
          </a>
