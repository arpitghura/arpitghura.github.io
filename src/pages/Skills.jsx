  ...
  >
    <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[54px] w-[94%] md:w-full">
      <div className="flex flex-col justify-start md:mt-0 mt-[3px] w-[18%] md:w-full">
        ...
        <Line className="bg-green_A200_dd h-1 w-[30%] md:w-[25%]" />
      </div>
      ...
      <div className="flex flex-col gap-[53px] items-center justify-start w-[73%] md:w-full">
        <div className="flex flex-col items-start justify-start pr-[3px] py-[3px] w-[90%]">
          ...
          <div className="flex sm:flex-col flex-row md:gap-[25px] items-center md:items-start md:mt-[20px] mt-[15px] w-[90%] gap-x-4">
            ...
            <div className="bg-blue_gray_900 flex sm:flex-1 flex-row gap-[10px] justify-center px-5 py-3 rounded-[10px]">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35" viewBox="0 0 40 48">
                <linearGradient id="NRNx2IPDe7PJlJvrxOKgWa_MWiBjkuHeMVq_gr1" x1="24" x2="24" y1="43.734" y2="4.266" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#0a070a"></stop><stop offset=".465" stopColor="#2b2b2b"></stop><stop offset="1" stopColor="#4b4b4b"></stop></linearGradient><circle cx="24" cy="24" r="19.734" fill="url(#NRNx2IPDe7PJlJvrxOKgWa_MWiBjkuHeMVq_gr1)"></circle><rect width="3.023" height="15.996" x="15.992" y="16.027" fill="#fff"></rect><linearGradient id="NRNx2IPDe7PJlJvrxOKgWb_MWiBjkuHeMVq_gr2" x1="30.512" x2="30.512" y1="33.021" y2="18.431" gradientUnits="userSpaceOnUse"><stop offset=".377" stopColor="#fff" stop-opacity="0"></stop><stop offset=".666" stopColor="#fff" stop-opacity=".3"></stop><stop offset=".988" stopColor="#fff"></stop></linearGradient><rect width="2.953" height="14.59" x="29.035" y="15.957" fill="url(#NRNx2IPDe7PJlJvrxOKgWb_MWiBjkuHeMVq_gr2)"></rect><linearGradient id="NRNx2IPDe7PJlJvrxOKgWc_MWiBjkuHeMVq_gr3" x1="22.102" x2="36.661" y1="21.443" y2="40.529" gradientUnits="userSpaceOnUse"><stop offset=".296" stopColor="#fff"></stop><stop offset=".521" stopColor="#fff" stop-opacity=".5"></stop><stop offset=".838" stopColor="#fff" stop-opacity="0"></stop></linearGradient><polygon fill="url(#NRNx2IPDe7PJlJvrxOKgWc_MWiBjkuHeMVq_gr3)" points="36.781,38.094 34.168,39.09 15.992,16.027 19.508,16.027"></polygon>
              </svg>
              <Text
                className="font-semibold ml-1.5 mt-auto mb-auto text-white_A700"
                as="h6"
